...
export default function Depoimentos() {
  ...
  return (
    <section className="md:mt-32 mt-24 md:mx-0 mx-4" id="depoimentos-id-nav">
      <h2 className="text-center fjalla tracking-normal leading-tight hover:cursor-default text-3xl sm:text-4xl max-w-md m-auto">Veja o que nossos clientes dizem sobre nossos serviços</h2>
              ...
              <div className="w-11/12 m-auto rounded-2xl pt-4 px-4 pb-2 bg-slate-300">
                ...
                <div>
                  ...
                  <div className="flex justify-center items-center gap-2 mt-3">
                    <img src={`${process.env.PUBLIC_URL}/img/depoimentos/icon7.png`} alt="icon" className="h-7" />
                    <img src={`${process.env.PUBLIC_URL}/img/depoimentos/icon7.png`} alt="icon" className="h-7" />
                    <img src={`${process.env.PUBLIC_URL}/img/depoimentos/icon7.png`} alt="icon" className="h-7" />
                    <img src={`${process.env.PUBLIC_URL}/img/depoimentos/icon7.png`} alt="icon" className="h-7" />
                    <img src={`${process.env.PUBLIC_URL}/img/depoimentos/icon7.png`} alt="icon" className="h-7" />
