          ...
          <div className="p-5">
            ...
            <div>
              ...
              <div className="flex justify-center gap-5 mt-6">
                <button className="text-black px-3 py-1 border border-black rounded-lg hover:bg-blue-500 hover:text-white hover:border-none hover:font-bold">
                  Google
                </button>
                <button className="text-black px-3 py-1 border border-black rounded-lg hover:bg-black hover:text-white hover:border-none hover:font-bold">
                  Github
                </button>
              </div>
            </div>
